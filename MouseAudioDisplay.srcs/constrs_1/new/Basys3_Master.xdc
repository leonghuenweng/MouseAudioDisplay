...
set_property PACKAGE_PIN W5 [get_ports basys3_clock]							
	...
	create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports basys3_clock]
 
# Switches
set_property PACKAGE_PIN V17 [get_ports {sw[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw[0]}]
set_property PACKAGE_PIN V16 [get_ports {sw1J}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw1J}]
